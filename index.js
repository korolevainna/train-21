...
class Musician {
 ...
 console.log(`==== 1`);
 //const musician = new Musician("Alex", "Guitare");
 musician.play();
...
class Guitarist extends Musician {
 ...
 console.log(`==== 2`);
//const guitarist = new Guitarist("Jek", "Guitare", "Jazz");
 guitarist.play();
...
class Bassist extends Musician {
 ...
 console.log(`==== 3 `);
 //const bassist = new Bassist("Ray", "Bom-bom", "Scorpions");
 bassist.play();
...
const jay = new Musician("Jay");
const jek = new Musician("Jek");
const roy = new Musician("Roy");
const blind = new Musician("Blind");
//const band = new Band("nameBand", [jay, jek, roy, blind]);
band.playMusic();
